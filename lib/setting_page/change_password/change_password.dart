              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      CustomInputFormField(hintText: "Enter Old Password" , validator: (value){}, icon: Icons.lock, ),
                      SizedBox(height: 15,),

                      CustomInputFormField(hintText: "Enter New Password" , validator: (value){}, icon: Icons.lock, ),
                      SizedBox(height: 15,),

                      CustomInputFormField(hintText: "Confirm Password" , validator: (value){}, icon: Icons.lock, ),
                      SizedBox(height: 15,),
